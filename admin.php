...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="width:300px;" id="mySidebar">
    ...
    <div class="w3-container w3-row">
        <div class="w3-col s4">
            <img src="1.jpeg" class="w3-circle w3-margin-right" style="width:46px">
        </div>
        <div class="w3-col s8 w3-bar">
            <span>Welcome, <strong>Admin</strong></span><br>
            <a href="0.php" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i></a>
            <a href="ap.html" class="w3-bar-item w3-button"><i class="fa fa-user"></i></a>
            <a href="password.php" class="w3-bar-item w3-button"><i class="fa fa-cog"></i></a>
        </div>
    </div>
    <hr>
    <div class="container">
    ...
    <div class="w3-bar-block">
        ...
        <a href="seeatten_a.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar fa-fw"></i>  Attendance</a>
        <a href="user.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>  Views</a>
        <a href="seemarks_a.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bullhorn fa-fw"></i>  Marks</a>
        <a href="seeclass.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  class</a>
        <a href="seecourse.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-book fa-fw"></i>  course</a>
        <a href="see_by_teacher.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-address-book fa-fw"></i>  Teachers</a>
        <a href="seestudent_a.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-address-book-o fa-fw"></i>  Students</a>
        <a href="password.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  Settings</a><br><br>
    </div>
</nav>
