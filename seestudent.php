...
<body>
    ...
    $conn->close();
    ?>
    <button onclick="window.location.href = 'student.html';" style="padding: 10px 20px; background-color: #f44336; color: #fff; border: none; border-radius: 4px; cursor: pointer; transition: background-color 0.3s ease;">Cancel</button>
</body>
</html>
