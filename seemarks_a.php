...
<div class="container">
    ...
    <div class="student-info">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<table>";
                echo "<tr><th>Student ID</th><th>Student Name</th><th>Class ID</th><th>Kannada</th><th>Hindi</th><th>English</th><th>Maths</th><th>Science</th><th>Social</th><th>Total Marks</th><th>Percentage</th></tr>";
    ...
    <button onclick="window.location.href = 'admin.php';" style="padding: 10px 20px; background-color: gray; color: #fff; border: none; border-radius: 4px; cursor: pointer; transition: background-color 0.3s ease;">Cancel</button>
    </div>
</div>
